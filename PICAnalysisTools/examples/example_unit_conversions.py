...
import numpy as np
from PICAnalysisTools.core.unit_conversions import magnitude_conversion, magnitude_conversion_area, magnitude_conversion_vol
...
Int_SI    = magnitude_conversion_area(Intensity, "centi", "", reciprocal_units = True)
...
Int    = magnitude_conversion_area(Intensity_SI, "", "centi", reciprocal_units = True)
...
n_e_SI = magnitude_conversion_vol(n_e, "centi", "", reciprocal_units = True)
...
N_E    = magnitude_conversion_vol(N_E_SI, "", "centi", reciprocal_units = True)
print("Plasma density in SI units: %0.2e m^-3" % N_E_SI)
