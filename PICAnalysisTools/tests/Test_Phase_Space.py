...
yplt_min, yplt_max = plt_limits_log(YAG, min_offset = 0, max_offset = 0)
...
# Need to check again the clim. Is the output from the function being correctly inputted into the plotting?
